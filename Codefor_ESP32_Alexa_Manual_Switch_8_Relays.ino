/**********************************************************************************
 *  TITLE: control your appliances (8 channel Relay Module) with Switch + Alexa control using ESP32.
...
// device names
String Device_1_Name = "ENTER YOUR DEVICE NAME";
String Device_2_Name = "ENTER YOUR DEVICE NAME";
String Device_3_Name = "ENTER YOUR DEVICE NAME";
String Device_4_Name = "ENTER YOUR DEVICE NAME";
String Device_5_Name = "ENTER YOUR DEVICE NAME";
String Device_6_Name = "ENTER YOUR DEVICE NAME";
String Device_7_Name = "ENTER YOUR DEVICE NAME";
String Device_8_Name = "ENTER YOUR DEVICE NAME";
